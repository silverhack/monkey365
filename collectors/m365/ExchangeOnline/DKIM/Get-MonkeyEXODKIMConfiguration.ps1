...
<#
        .SYNOPSIS
		Collector to get information about DKIM from Exchange Online
        ...
        .NOTES
	        Author		: Juan Garrido
            Twitter		: @tr1ana
            File Name	: Get-MonkeyEXODKIMConfiguration
            Version     : 1.0
	...
	process {
		$msg = @{
			MessageData = ($message.MonkeyGenericTaskMessage -f $collectorId,"Exchange Online DKIM signing configuration",$O365Object.TenantID);
		...
		$DKIM = Get-PSExoAdminApiObject @p
	}
	end {
		if ($null -ne $DKIM) {
