...
<#
        .SYNOPSIS
		Collector to get information about remote domain in Exchange Online
	...
	process {
		$msg = @{
			MessageData = ($message.MonkeyGenericTaskMessage -f $collectorId,"Exchange Online remote domain",$O365Object.TenantID);
		...
		$exo_remote_domain = Get-PSExoAdminApiObject @p
	}
	end {
