...
<#
        .SYNOPSIS
		Collector to get information about outbound spam filter policy in Exchange Online
	...
	process {
		$msg = @{
			MessageData = ($message.MonkeyGenericTaskMessage -f $collectorId,"Exchange Online hosted outbound spam filter policy",$O365Object.TenantID);
