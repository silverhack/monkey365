...
<#
        .SYNOPSIS
		Collector to get information about hosted connection filter policy in Exchange Online
	...
	process {
		$msg = @{
			MessageData = ($message.MonkeyGenericTaskMessage -f $collectorId,"Exchange Online Hosted connection filter policy",$O365Object.TenantID);
		...
		$p = @{
			...
			Command = 'Get-HostedConnectionFilterPolicy';
			Method = "POST";
			InformationAction = $O365Object.InformationAction;
			Verbose = $O365Object.Verbose;
			Debug = $O365Object.Debug;
		}
		$hosted_conn_filter = Get-PSExoAdminApiObject @p
	}
	end {
