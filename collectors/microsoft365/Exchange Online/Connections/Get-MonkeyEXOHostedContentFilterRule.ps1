...
<#
        .SYNOPSIS
		Collector to get information about hosted content filter rules in Exchange Online
	...
	process {
		$msg = @{
			MessageData = ($message.MonkeyGenericTaskMessage -f $collectorId,"Exchange Online Hosted content filter rule",$O365Object.TenantID);
		...
		$p = @{
			...
			Command = 'Get-HostedContentFilterRule';
			Method = "POST";
			InformationAction = $O365Object.InformationAction;
			Verbose = $O365Object.Verbose;
			Debug = $O365Object.Debug;
		}
		$hosted_content_rule = Get-PSExoAdminApiObject @p
	}
	end {
