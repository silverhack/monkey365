...
<#
        .SYNOPSIS
		Collector to get information about mailbox retention policies in Exchange Online
	...
	begin {
		...
		$monkey_metadata = @{
			...
			ruleSuffixes = @(
				"o365_exo_mbox_retention_policy"
			);
			dependsOn = @(
	...
	process {
		$msg = @{
			MessageData = ($message.MonkeyGenericTaskMessage -f $collectorId,"Exchange Online mailbox retention policy",$O365Object.TenantID);
		...
		$p = @{
			...
			Command = 'Get-RetentionPolicy';
			Method = "POST";
			InformationAction = $O365Object.InformationAction;
			Verbose = $O365Object.Verbose;
			Debug = $O365Object.Debug;
		}
		$retentionpolicy = Get-PSExoAdminApiObject @p
	}
	end {
