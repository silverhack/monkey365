...
Function Get-MonkeyMsolUser{
    ...
    try{
        ...
        #Get xml file
        $xmlfile = ("{0}/core/api/m365/o365legacy/ws/users/envelope.xml" -f $O365Object.Localpath)
        $nextPageXmlFile = ("{0}/core/api/m365/o365legacy/ws/users/nextPage.xml" -f $O365Object.Localpath)
