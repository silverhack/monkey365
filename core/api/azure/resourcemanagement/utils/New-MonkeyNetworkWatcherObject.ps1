...
Function New-MonkeyNetworkWatcherObject {
<#
        .SYNOPSIS
        ...
        .NOTES
	        Author		: Juan Garrido
            Twitter		: @tr1ana
            File Name	: New-MonkeyNetworkWatcherObject
            Version     : 1.0
    ...
    Process{
        try{
            ...
            #Create PsObject
            $_obj = New-Object -TypeName PsObject -Property $NWObject
            #return object
            return $_obj
        }
        catch{
            $msg = @{
			    MessageData = ($message.MonkeyObjectCreationFailed -f "Network Watcher object");
