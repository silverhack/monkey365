...
Function Select-MonkeyTenantConsole{
    ...
    Begin{
        ...
        try{
            ...
            Write-Information "Unable to create tenant choices"
            $msg = @{
            ...
            while ($true) {
                ...
                if ($sbsID -notmatch '\D') {    # if the input does not contain an non-digit
                    ...
                    if ($index -ge 0 -and $index -lt $tenants.Count) {
                        ...
                        Write-Information ("You have selected {0} Tenant" -f $tenants[$index].DisplayName) -InformationAction $InformationAction
