...
Function Get-MonkeyAZGroupMember{
    <#
        .SYNOPSIS
		Get Group Members
        ...
        .NOTES
	        Author		: Juan Garrido
            Twitter		: @tr1ana
            File Name	: Get-MonkeyAZGroupMember
            Version     : 1.0
    ...
    Begin{
        ...
        elseif($PSBoundParameters.ContainsKey('GroupId') -and $PSBoundParameters.GroupId){
            #Get group by Id
            $my_grp = Get-MonkeyADObjectByObjectId -ObjectId $PSBoundParameters.GroupId
