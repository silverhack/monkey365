...
Function Get-MonkeyMSGraphAuthenticationMethodsPolicy{
    <#
        .SYNOPSIS
        ...
        .NOTES
	        Author		: Juan Garrido
            Twitter		: @tr1ana
            File Name	: Get-MonkeyMSGraphAuthenticationMethodsPolicy
            Version     : 1.0
    ...
    try{
        ...
        $tenant_auth_method_policy = Get-MonkeyMSGraphObject @params
