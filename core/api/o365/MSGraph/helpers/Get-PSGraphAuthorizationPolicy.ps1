...
Function Get-PSGraphAuthorizationPolicy{
    <#
        .SYNOPSIS
        ...
        .NOTES
	        Author		: Juan Garrido
            Twitter		: @tr1ana
            File Name	: Get-PSGraphAuthorizationPolicy
            Version     : 1.0
    ...
    try{
        ...
        $tenant_auth_policy = Get-GraphObject @params
        #Add to dict
        ...
        $tenant_flows_policy = Get-GraphObject @params
        #Add to dict
