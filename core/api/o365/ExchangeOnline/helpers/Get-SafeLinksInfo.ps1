...
Function Get-SafeLinksInfo{
    ...
    Begin{
        ...
        if($null -ne (Get-Command -Name Get-ExoMonkeySafeLinksPolicy -errorAction Ignore)){
            ...
            try{
                $safeLinksCollection.SafeLinksPolicy = Get-ExoMonkeySafeLinksPolicy
                ...
                Write-Information @msg
                $safeLinksCollection.SafeLinksRules = Get-ExoMonkeySafeLinksRule
                ...
                Write-Information @msg
                $safeLinksCollection.ATPProtectionPolicyRule = Get-ExoMonkeyATPProtectionPolicyRule
            }
            catch{
                $msg = @{
                    MessageData = ($_);
