...
Function Get-HostedContentFilterInfo{
    ...
    Begin{
        ...
        if($null -ne (Get-Command -Name Get-ExoMonkeyHostedContentFilterPolicy -errorAction Ignore)){
            ...
            try{
                ...
                $hostedContentCollection.HostedContentFilterPolicy = Get-ExoMonkeyHostedContentFilterPolicy
                ...
                Write-Information @msg
                $hostedContentCollection.HostedContentFilterRule = Get-ExoMonkeyHostedContentFilterRule
                ...
                Write-Information @msg
                $hostedContentCollection.EOPProtectionPolicyRule = Get-ExoMonkeyEOPProtectionPolicyRule
                ...
                Write-Information @msg
                $hostedContentCollection.QuarantineSettings = Get-ExoMonkeyQuarantinePolicy
            }
            catch{
                $msg = @{
                    MessageData = ($_);
