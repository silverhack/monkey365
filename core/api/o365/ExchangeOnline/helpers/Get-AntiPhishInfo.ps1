...
Function Get-AntiPhishingInfo{
    ...
    Begin{
        ...
        if($null -ne (Get-Command -Name Get-ExoMonkeyAntiphishPolicy -errorAction Ignore)){
            ...
            try{
                ...
                $phishFilterCollection.AntiPhishPolicy = Get-ExoMonkeyAntiphishPolicy
                #Get AntiPhish Rules
                $phishFilterCollection.AntiPhishRules = Get-ExoMonkeyAntiPhishRule
                #Get EOP protection rules
                $phishFilterCollection.EOPProtectionPolicyRule = Get-ExoMonkeyEOPProtectionPolicyRule
            }
            catch{
                $msg = @{
                    MessageData = ($_);
