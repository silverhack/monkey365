...
Function Get-SafeAttachmentInfo{
    ...
    Begin{
        ...
        if($null -ne (Get-Command -Name Get-ExoMonkeySafeAttachmentPolicy -errorAction Ignore)){
            ...
            try{
                ...
                $safeAttachmentCollection.SafeAttachmentsPolicy = Get-ExoMonkeySafeAttachmentPolicy
                ...
                Write-Information @msg
                $safeAttachmentCollection.SafeAttachmentsRules = Get-ExoMonkeySafeAttachmentRule
                ...
                Write-Information @msg
                $safeAttachmentCollection.ATPProtectionPolicyRule = Get-ExoMonkeyATPProtectionPolicyRule
            }
            catch{
                $msg = @{
                    MessageData = ($_);
