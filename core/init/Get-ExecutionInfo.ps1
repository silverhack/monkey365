...
Function Get-ExecutionInfo{
    ...
    if($O365Object.Tenant){
        ...
        if($O365Object.Instance -eq "Azure"){
            $roles = $O365Object.userPermissions.permissions | Select-Object -ExpandProperty RoleName -ErrorAction Ignore
        }
        else{
            $roles = $O365Object.userPermissions.permissions | Select-Object -ExpandProperty displayName -ErrorAction Ignore
        }
        #Get Profile
        if($O365Object.Instance -eq "Azure"){
