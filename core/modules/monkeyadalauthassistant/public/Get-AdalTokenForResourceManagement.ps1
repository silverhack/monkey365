...
Function Get-AdalTokenForResourceManagement{
    <#
        .SYNOPSIS
        ...
        .NOTES
	        Author		: Juan Garrido
            Twitter		: @tr1ana
            File Name	: Get-AdalTokenForResourceManagement
            Version     : 1.0
    ...
    $access_token = Get-MonkeyAdalToken @internal_params -Resource $AzureEnvironment.ResourceManager;
