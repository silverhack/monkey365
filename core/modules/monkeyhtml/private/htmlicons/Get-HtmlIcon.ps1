...
Function Get-HtmlIcon{
    ...
    Begin{
        $all_icons = @{
            ...
            'General'='assets/inc-azicons/identity/10221-icon-service-Azure-Active-Directory.svg'
            ...
            'Microsoft Entra ID Identity'='assets/inc-azicons/identity/10230-icon-service-Users.svg'
