ConvertFrom-StringData @'
    ...
    FileNotFound                     = File {0} was not found on {1}
    DuplicateFileFound               = Duplicate file {0} was found on {1}
    InvalidRuleFound                 = The {0} rule is invalid
    ...
    BuildQueryErrorMessage           = Unable to build query
    UnableToCloneObject              = Unable to clone {0} object
