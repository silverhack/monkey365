...
Function Get-MonkeyAzStorageAccountClassicDiagnosticSetting {
    <#
        .SYNOPSIS
		Get storage account diagnostic settings (Classic)
        ...
        .NOTES
	        Author		: Juan Garrido
            Twitter		: @tr1ana
            File Name	: Get-MonkeyAzStorageAccountClassicDiagnosticSetting
            Version     : 1.0
