...
Function New-MonkeySQLVMObject {
<#
        .SYNOPSIS
		Create a new SQL server for VM object
        ...
        .NOTES
	        Author		: Juan Garrido
            Twitter		: @tr1ana
            File Name	: New-MonkeySQLVMObject
            Version     : 1.0
    ...
    Process{
        try{
            ...
            $DatabaseObject = [ordered]@{
		        ...
		        osType = $InputObject.properties | Select-Object -ExpandProperty osType -ErrorAction Ignore
                extensions = $null;
