...
Function New-MonkeyCacheRedisObject {
<#
        .SYNOPSIS
		Create a new cache redis object
        ...
        try{
            ...
            $RedisObject = [ordered]@{
                ...
                networking = [PSCustomObject]@{
                    ...
                    supportsHttpsTrafficOnly = If($InputObject.properties.enableNonSslPort -eq $false){$True}Else{$false};
