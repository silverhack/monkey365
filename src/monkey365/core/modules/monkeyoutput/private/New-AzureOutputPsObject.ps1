...
Function New-AzureOutputPsObject {
<#
        .SYNOPSIS
		Create a new Azure output object
        ...
        .NOTES
	        Author		: Juan Garrido
            Twitter		: @tr1ana
            File Name	: New-AzureOutputPsObject
            Version     : 1.0
    ...
    Process{
        Try{
            ...
            #Create PsObject
            $_obj = New-Object -TypeName PsObject -Property $AzureObject
            #return object
            return $_obj
        }
        Catch{
