...
Function New-MsalApplicationForPnP{
    <#
        .SYNOPSIS
        ...
        .NOTES
	        Author		: Juan Garrido
            Twitter		: @tr1ana
            File Name	: New-MsalApplicationForPnP
            Version     : 1.0
    ...
    Begin{
        ...
        #Get ClientId
        $clientId = Get-WellKnownAzureService -AzureService SharePointPnP
        #Get redirectUri
    ...
    End{
        try{
            ...
            $msg = @{
                Message = ($Script:messages.MSALApplicationError -f "SharePoint PnP Management Shell");
                InformationAction = $InformationAction;
                Verbose = $Verbose;
                Debug = $Debug;
            }
